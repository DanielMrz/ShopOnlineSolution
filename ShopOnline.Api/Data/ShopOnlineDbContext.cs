...
namespace ShopOnline.Api.Data
{
    ...
    {
        // DbContext jest klasą w frameworku.NET, a dokładniej w bibliotece Entity Framework, która umożliwia interakcję z bazą danych w aplikacjach
        // DbContext jest odpowiedzialny za zarządzanie sesją do bazy danych, czyli śledzenie stanu obiektów,
        // ich zmian, tworzenie zapytań do bazy danych i wykonywanie tych zapytań.
        // DbContext łączy w sobie definicje modeli (klas reprezentujących strukturę danych w bazie) oraz logikę potrzebną do wykonywania operacji bazodanowych.
